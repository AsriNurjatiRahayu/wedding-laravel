  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div class="logo">
        ...
        <!-- <a href="index.html"><img src="landingpage/assets/img/logo.png" alt="" class="img-fluid"></a>-->
      </div>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href=""><span>Welcome, viaa</span> <i class="bi bi-chevron-down"></i></a>
                <ul>
          <li><a href="http://app-wo.test/user/order">Riwayat Pesanan</a></li>
                  <li>
                    <a href="http://app-wo.test/user/logout" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
                    <form action="http://app-wo.test/user/logout" method="post" class="d-none" id="logout-form">
    ...
    <div id="heroCarousel" class="container carousel carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
      ...
      <div class="carousel-item active">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">Welcome to <span>Mantumanten WO</span></h2>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">Mantumanten WO</h2>
          <p class="animate__animated animate__fadeInUp">Merupakan salah satu jasa Wedding Organizer yang populer di Kabupaten Garut.</p>
        </div>
      </div>
...
<section class="service-details">
  <div class="container" align="center" >
    ...
    <div class="row">
        ...
        <div class="card">
          <div class="card-img">
                            <img src="landingpage/assets/img/hero-bg1.jpeg" class="card-img-top" alt="Dekorasi Silver">
                          </div>
          <div class="card-body">
            <h4 class="card-title"><a href="/service?servcat=dekorasi">Akad Package</a> </h4><br>
            <div class="pricing row">
              <h4>Rp. 13.000.000</h4>
              
              <a href="http://app-wo.test/service/dekorasi-silver" class="btn btn-primary text-white text-center">Detail Paket</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 d-flex align-items-stretch" data-aos="fade-up">
        <div class="card">
          <div class="card-img">
                        <img src="landingpage/assets/img/service-details-1.jpg" class="card-img-top" alt="Dekorasi Gold">
                          </div>
          <div class="card-body">
            ...
            <div class="pricing row">
              ...
              <a href="http://app-wo.test/service/dekorasi-gold" class="btn btn-primary text-white text-center">Detail Paket</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card">
          <div class="card-img">
                        <img src="landingpage/assets/img/service-details-2.jpg" class="card-img-top" alt="Dekorasi Gold">
                          </div>
          <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-info">
            ...
            <div class="social-links mt-3">
              <a href="https://www.facebook.com/mantumangtenwo/" class="facebook"><i class="bx bxl-facebook"></i></a>
              <a href="https://www.instagram.com/mantumantenwo/" class="instagram"><i class="bx bxl-instagram"></i></a>
            </div>        
          </div>
        </div>
      </div>
